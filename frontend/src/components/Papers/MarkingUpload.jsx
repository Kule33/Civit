// frontend/src/components/Papers/MarkingUpload.jsx
import React, { useState, useRef, useEffect } from 'react';
import { Upload, FileText, X, CheckCircle, AlertCircle, FileCheck } from 'lucide-react';
...
import { uploadMarkingToCloudinary, saveMarkingMetadata } from '../../services/markingService';
...
const MarkingUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showOverlay({
        status: 'loading',
        message: 'Uploading marking scheme to Cloudinary...',
        autoClose: false
      });

      // Upload to Cloudinary
      const uploadResult = await uploadMarkingToCloudinary(selectedFile, metadata, setUploadProgress);
      ...
      // Save to backend
      await saveMarkingMetadata(markingData);
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card>
            <h2 className="text-lg font-semibold mb-4">Upload Marking Scheme (PDF)</h2>
                ...
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3 flex-1">
                      <FileCheck className="w-10 h-10 text-green-600 flex-shrink-0" />
        ...
        {/* Right column - Metadata Form (Same as PaperUpload) */}
        <div className="lg:col-span-2">
          <Card>
            <h2 className="text-lg font-semibold mb-4">Marking Scheme Metadata</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Same metadata fields as PaperUpload */}
              {metadata.country && (
