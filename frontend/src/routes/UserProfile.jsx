...
import { getMyProfile, updateMyProfile, getUserActivity } from '../services/userService';
import { User, MapPin, CreditCard, Phone, UserCircle, Edit2, Save, X, Mail, ArrowLeft, FileText, TrendingUp, Clock, CheckCircle, Calendar, Upload, Crown, UserRound, UserCircle2 } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchActivity = async () => {
      ...
      try {
        ...
        const stats = await getUserActivity(profile.id);
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          {loadingActivity ? (
            ...
            <div className="space-y-4">
              {/* Stats Grid */}
              <div className={`grid grid-cols-1 gap-4 ${profile.role?.toLowerCase() === 'admin' ? 'md:grid-cols-5' : 'md:grid-cols-3'}`}>
